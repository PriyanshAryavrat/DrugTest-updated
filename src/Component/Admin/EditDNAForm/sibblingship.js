...
class SibblingShipOther extends React.Component {
  ...
  componentDidMount(){
    ...
    let {allegedMother,mother2,child1,child2,additionalPersons,bloodCellTransfusion}=this.props.formData;
  ...
  if(allegedMother){
    this.setState({
      ...
      motherdateofbirth: new Date(allegedMother.dob),
  ...
  if(child1){
    this.setState({
      childFirstName: child1.firstName,
        childMiddleName: child1.middleName,
        childLastName:child1.lastName,
        childdateofbirth:new Date(child1.dob),
        childsex: child1.gender,
        childphoneNo: child1.phone,
        childemail: child1.email,
        childpassword: child1.password,
        childdrivingLicence: child1.drivingLicence,
        childDlState:child1.dlState,
        childsampleType: child1.sampleType,
        childsampleTypeOther: child1.sampleTypeOther,
        childraceEthnicity:child1.race,
        childraceEthnicityOther: child1.raceOther,
        childdateRead:child1.hasDL,
        childEmailme:child1.pickupPreference,
        childCallme:child1.allowCall
      })
      if(child1.dob){
        this.handleChanges(new Date(child1.dob));
      }
    }
    if(child2){
      this.setState({
        child2FirstName: child2.firstName,
          child2MiddleName: child2.middleName,
          child2LastName:child2.lastName,
          child2dateofbirth:new Date(child2.dob),
          child2sex: child2.gender,
          child2phoneNo: child2.phone,
          child2email: child2.email,
          child2password: child2.password,
          child2drivingLicence: child2.drivingLicence,
          child2DlState:child2.dlState,
          child2sampleType: child2.sampleType,
          child2sampleTypeOther: child2.sampleTypeOther,
          child2raceEthnicity:child2.race,
          child2raceEthnicityOther: child2.raceOther,
          child2dateRead:child2.hasDL,
          child2Emailme:child2.pickupPreference,
          child2Callme:child2.allowCall
        })

        if(child2.dob){
          this.handleChanged(new Date(child2.dob));
        }
      }
     ...
     if(mother2){
    this.setState({
      mother2FirstName: mother2.firstName,
      mother2MiddleName: mother2.middleName,
      mother2LastName:mother2.lastName,
      mother2dateofbirth:new Date(mother2.dob),
      mother2sex: mother2.gender,
      mother2phoneNo: mother2.phone,
      mother2email: mother2.email,
      mother2password: mother2.password,
      mother2drivingLicence: mother2.drivingLicence,
      mother2DlState: mother2.dlState,
      mother2sampleType: mother2.sampleType,
      mother2sampleTypeOther: mother2.sampleTypeOther,
      mother2raceEthnicity:mother2.race,
      mother2raceEthnicityOther: mother2.raceOther,
      mother2dateRead:mother2.hasDL,
      mother2Emailme:mother2.pickupPreference,
      mother2Callme:mother2.allowCall,
    });
  }
...
if(additionalPersons){
  this.setState({
    ...
    this.setState({
      ...
      siblingship:this.props.formData.siblingship,
      //allegedFather:allegedFather?true:false,
      //mother:allegedMother?true:false,
      child1:child1&&child1.dob?true:false,
      mother2:mother2&&mother2.dob?true:false,
      child:child2&&child2.dob?true:false,
                      ...
                      <div className="form-group formbox">
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              type="radio"
                              checked={this.state.fullvsunrelated||this.state.siblingship=="Full vs Half"?true:false}
                              className="form-check-input"
                              name="optionsRadios6"
                              onChange={(e) => {
                                this.setState({
                      ...
                      <div className="form-group formbox">
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              type="radio"
                              checked={this.state.fullvshalf||this.state.siblingship=="Half vs Unrelated"?true:false}
                              className="form-check-input"
                              name="optionsRadios6"
                      ...
                      <div className="form-group formbox">
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              type="radio"
                              checked={this.state.halfvsunrelatedd||this.state.siblingship=="full vs half"?true:false}
                              className="form-check-input"
                              name="optionsRadios6"
                              value="full vs half"
                              onChange={(e) => {
                      ...
                      <div className="form-check">
                        <label className="form-check-label">
                          <input
                            ...
                            name="optionscheckbox"
                            value=""
                            checked={this.state.mother2Emailme}
                            onChange={(e) => {
                              this.setState({
                      ...
                      <div className="form-check">
                        <label className="form-check-label">
                          <input
                            ...
                            name="optionscheckbox"
                            value=""
                            checked={this.state.mother2Callme}
                            onChange={(e) => {
                              this.setState({
                      ...
                      <div className="form-check">
                        <label className="form-check-label">
                          <input
                            ...
                            className="form-check-input"
                            name="optionscheckbox"
                            value={this.state.mother2dateRead}
                            checked={this.state.mother2dateRead}
                            onChange={(value) => {
                      ...
                      <div className="form-check">
                        <label className="form-check-label">
                          <input
                            ...
                            className="form-check-input"
                            name="optionscheckbox"
                            checked={this.state.child2Emailme}
                            value=""
                            onChange={(e) => {
                              this.setState({
                      ...
                      <div className="form-check">
                        <label className="form-check-label">
                          <input
                            ...
                            name="optionscheckbox"
                            value=""
                            checked={this.state.child2Callme}
                            onChange={(e) => {
                              this.setState({
                      ...
                      <div className="form-check">
                        <label className="form-check-label">
                          <input
                            ...
                            className="form-check-input"
                            name="optionscheckbox"
                            checked={this.state.child2dateRead}
