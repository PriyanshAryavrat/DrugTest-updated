...
class MaternityOther extends React.Component {
  ...
  componentDidMount() {
    ...
    let { allegedMother, child, additionalPersons, bloodCellTransfusion } = this.props.formData;
    ...
    if (bloodCellTransfusion) {
      this.setState({
        ...
        party: bloodCellTransfusion.party ?? null,
                          ...
                          <div className="form-check">
                            <label className="form-check-label">
                              <input
                                ...
                                className="form-check-input"
                                name="optionsRadios5"
                                checked={this.state.relationship == "Personal/Peace of mind"}
