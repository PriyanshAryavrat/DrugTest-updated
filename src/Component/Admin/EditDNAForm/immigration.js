...
class ImmigrationOther extends React.Component {
  ...
  componentDidMount(){
    ...
    let {beneficiaries}=this.props.formData;

  if(beneficiaries&&beneficiaries.length>0){
    this.setState({
      BeneficiaryRelation: beneficiaries[0].relation,
      Beneficiaryfirstname: beneficiaries[0].firstName,
      BeneficiarylastName: beneficiaries[0].lastName,
      Beneficiarymiddlename: beneficiaries[0].middleName,
      beneficiarydateofbirth:beneficiaries[0].dob?new Date (beneficiaries[0].dob):null,
      BeneficiaryCase: beneficiaries[0].case,
      BeneficiaryLocation: beneficiaries[0].currentLocation,
      raceEthnicity: beneficiaries[0].race,
      raceEthnicityOther: beneficiaries[0].raceOther,
      relationsex: beneficiaries[0].gender,
      BeneficiaryphoneNo1: beneficiaries[0].phoneNumber,
      BeneficiaryphoneNo2: beneficiaries[0].phoneNumber2,
      BeneficiaryphoneNo3: beneficiaries[0].phoneNumber3,
    ...
    this.setState({
     ...
     passport:this.props.formData.passport,
     dateofbirth: this.props.formData.dob?new Date(this.props.formData.dob):null,
     location: this.props.formData.currentLocation,
     raceEthnicity1: this.props.formData.race,
     raceOther1: this.props.formData.raceOther,
     sex: this.props.formData.gender,
     phoneNo1: this.props.formData.phoneNumber,
     phoneNo2: this.props.formData.phoneNumber2,
     phoneNo3: this.props.formData.phoneNumber3,
     email:this.props.formData.email,
     drivingLicence: this.props.formData.drivingLicence,
     dlState: this.props.formData.dlState,
     hasDl: this.props.formData.hasDl,
     isTested: this.props.formData.isTested,
     relationToBeneficiary: this.props.formData.relationToBeneficiary,
     relationToBeneficiaryOther: this.props.formData.relationToBeneficiaryOther,
     hasAdditionalTest:this.props.formData.relationToBeneficiary=="Other"?true:false,
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              name="optionscheckbox"
                              value=""
                              checked={this.state.relationToBeneficiary=="Mother"?true:false}
                              onChange={(e)=>{
                                this.setState({
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              name="optionscheckbox"
                              value=""
                              checked={this.state.relationToBeneficiary=="Father"?true:false}
                              onChange={(e)=>{
                                this.setState({
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              className="form-check-input"
                              name="optionscheckbox"
                              checked={this.state.relationToBeneficiary=="Son"?true:false}
                              value=""
                              onChange={(e)=>{
                                this.setState({
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              name="optionscheckbox"
                              value=""
                              checked={this.state.relationToBeneficiary=="Daughter"?true:false}
                              onChange={(e)=>{
                                this.setState({
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              name="optionscheckbox"
                              value=""
                              checked={this.state.relationToBeneficiary=="Sister"?true:false}
                              onChange={(e)=>{
                                this.setState({
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              name="optionscheckbox"
                              value=""
                              checked={this.state.relationToBeneficiary=="Brother"?true:false}
                              onChange={(e)=>{
                                this.setState({
                        ...
                        <div className="form-check">
                          <label className="form-check-label">
                            <input
                              ...
                              className="form-check-input"
                              name="optionscheckbox"
                              checked={this.state.relationToBeneficiary=="Other"?true:false}
                              onChange={(e)=>{
                                this.setState({
