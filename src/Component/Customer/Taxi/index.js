  ...
  handleSubmit = async (evt) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setTimeout(() => {
          this.setState({ redirectTo: "/taxi-pdf/" + res.data.data.formId });
          this.setState({disabled: false});
        }, 2000);
      });
  };
                      ...
                      <Col md={12}>
                        ...
                        <div className="form-group formbox checkbox-style m0 authorizecheck">
                          ...
                          <label title="" for="formBasicCheckbox" className="form-check-label">
                            I authorize Accurate C&S Services, Inc. to release my drug and/or alcohol test results to Oakland Taxi
                            </label>
                        </div>
