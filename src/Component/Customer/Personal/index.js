...
class PersonalTest extends React.Component {
  ...
  handleSubmit = async (evt) => {
    ...
    formData.append('dateOfRegistration', this.state.dateOfRegistration.toISOString());
    ...
    axios.post(apiPath.base_url, formData, {
      ...
      setTimeout(() => {
        this.setState({ redirectTo: "/personal-pdf/" + res.data.data.formId });
        this.setState({disabled: false});
      }, 2000);
    });
  };
                      ...
                      <Col md={12}>
                        <div className="form-group formbox checkbox-style authorizecheck">
                          <label title="" for="formBasicCheckbox">
                            ...
                            I authorize Accurate C&S Services, Inc. to release my drug and/or alcohol test results to the address listed above:
