...
class Infidelity extends React.Component {
  render() {
    return (
      <React.Fragment>
        <Container>
            ...
            <Col md="12">
              <div className="cpuc-enrollment-form">
                <div className="drugtopheader">
                  <h2 className="margin-bottom0">Infidelity Test</h2>
                </div>
                <div className="dnaconsent-formtable clearfix">
                                ...
                                <div className="sex-radiobox">
                                  <div className="form-check">
                                    <label className="form-check-label">
                                      <input type="radio" className="form-check-input" name="optionsRadios5" value="" /> M
                                    <i className="input-helper"></i>
                                    </label>
                                  </div>
                                  <div className="form-check">
                                    <label className="form-check-label">
                                      <input type="radio" className="form-check-input" name="optionsRadios5" value="" /> F
                                    <i className="input-helper"></i>
                                    </label>
                                  </div>
                                </div>
                  ...
                  <div className="individual-section">
                    ...
                    <div className="following-address">
                      <label className="margin-bottom10">Additional Testing (Select all that apply)</label>
                      <Row>
                        <Col lg={4} md={4} sm={4}>
                          <div className="form-check">
                            <label className="form-check-label">
                              <input type="checkbox" className="form-check-input" name="optionsCheck" value="" /> Semen detection
                                  <i className="input-helper"></i>
                            </label>
                          </div>
                        </Col>
                        <Col lg={4} md={4} sm={4}>
                          <div className="form-check">
                            <label className="form-check-label">
                              <input type="checkbox" className="form-check-input" name="optionsCheck" value="" /> Y-STR
                                  <i className="input-helper"></i>
                            </label>
                          </div>
                        </Col>
                        <Col lg={4} md={4} sm={4}>
                          <div className="form-check">
                            <label className="form-check-label">
                              <input type="checkbox" className="form-check-input" name="optionsCheck" value="" /> Other (Specify)
                                  <i className="input-helper"></i>
                            </label>
                          </div>
                        </Col>
