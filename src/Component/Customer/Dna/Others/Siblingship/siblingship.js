    ...
    <div className="col-md-12">
      ...
      <div className="cpuc-enrollment-form">
        <div className="cpuc-enrollment-header drugtopheader ">
          <h2 className="margin-bottom0">Siblingship Test</h2>
        </div>
          ...
          <div className="table-responsive margin-bottom20 ">
            <table border={2} width="100%" className="consent-outertable">
              <tbody><tr>
                ...
                <tr>
                  <td colSpan={8} className="tabletext-type">
                    <div className="selectfirstrow passport-selecttype margin-bottom20">
                      <h3>Select Test Type:</h3>
                    </div>
                    <div className="siblingshiprow passport-siblingship">
                      <h3>Siblingship:</h3>
                      <div className="selectcheck-group">
                        <div className="form-check">
                          <label className="form-check-label pull-left">
                            <input type="checkbox" className="form-check-input" /> <i className="input-helper" />
                            Full vs Unrelated
                          </label>
                        </div>
                        <div className="form-check">
                        ...
                        <div className="form-check topother">
                          <label className="form-check-label pull-left">
                            <input type="checkbox" className="form-check-input" /> <i className="input-helper" />
                            Other (Specify)
                          </label>
      ...
      <div className="cpuc-enrollment-form">
        <div className="cpuc-enrollment-sections">
          <div className="row">
            <div className="col-md-12">
              <div className="allegedform clearfix border-bottom0">
                {/*<h4 className="text-center">If child 1 is 18 years or older then display this page </h4>*/}
                <div className="siblingship-outer clearfix">
                  <div className="row">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6">
                      <div className="form-check">
                        <label className="form-check-label">
                          <input type="checkbox" className="form-check-input" name="optionsCheckbox" defaultValue />I
                          do not have a driver license or a state ID
                          <i className="input-helper" />
                        </label>
                      </div>
                    </div>
