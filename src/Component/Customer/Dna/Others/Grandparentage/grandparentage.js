              ...
              <tbody><tr>
                ...
                <tr className="legal-fillout">
                  ...
                  <td rowSpan={2}>
                    <div className="form-check">
                      <label className="form-check-label">
                        <input type="radio" className="form-check-input" name="optionsRadios1" defaultValue /> Grandfather
                        <i className="input-helper" />
                      </label>
                    </div>
                    <div className="form-check">
                      <label className="form-check-label">
                        <input type="radio" className="form-check-input" name="optionsRadios1" defaultValue /> Grandmother
                        <i className="input-helper" />
                      </label>
                    </div>
                    {/* <H4>Grandfather</H4>*/}
      ...
      <div className="cpuc-enrollment-form">
        <div className="cpuc-enrollment-sections">
          <div className="row">
            ...
            <div className="bluesample-collection">
              <p>For Sample Collection Company Use - Additional Information</p>
            </div>
            <h4>Will we be receving other samples for this case in a separate package?</h4>
            <div className="pull-left">
              <div className="form-check pull-left ">
                <label className="form-check-label">
                  <input type="radio" className="form-check-input" name="optionsRadio" value=""> No
                  <i className="input-helper"></i>
                </label>
              </div>
              <div className="form-check pull-left margin-left20">
                <label className="form-check-label">
                  <input type="radio" className="form-check-input" name="optionsRadio" value=""> Yes
                  <i className="input-helper"></i>
                </label>
              </div>
              <div className="approxdate margin-left20 pull-left">
...
<head>
  <title>Accurate Admin</title>
  <?php include('head.php'); ?>
</head>

<body cz-shortcut-listen="true" className="login-signup">
