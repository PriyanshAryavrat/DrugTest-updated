...
const PDF = ({ props }) => {
  ...
  return <Document>
    <Page size="A4" style={styles.page}>
      ...
      <Text style={styles.title}>Petitioner Info</Text>
      ...
      <View style={styles.formInputGroup}>
        <Text style={styles.input}>{props.firstName}{" "}{props.middleName}{" "}{props.lastName}</Text>
      ...
      <View style={styles.formBox}>
        <Text style={styles.label}>Petitioner Info</Text>

      </View>
      {props && <PetitionerInfo formData={props} />}
      <View style={styles.formBox}>
        <Text style={styles.label}>Beneficiary Info</Text>

      </View>
      {props && <BeneficiaryInfo formData={props} />}
    </Page>
  </Document>
};
