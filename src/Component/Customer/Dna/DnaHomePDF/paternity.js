...
const PDF = ({ props }) => {
  ...
  return <Document>
    <Page size="A4" orientation={'landscape'} style={styles.page}>
      ...
      <Text style={styles.title}>Paternity Test</Text>
      ...
      <View style={styles.formBox}>
        ...
        <Text style={styles.label1}>Driving License</Text>

      </View>
      <View style={styles.formInputGroup}>
        <Text style={styles.input1}>{props.drivingLicence}</Text>
      </View>
      <View style={styles.formInputGroup}>
        {<Alleged formData={props} />}
      </View>
