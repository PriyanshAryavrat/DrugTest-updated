...
class RenewalTCP extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      tabIndex: 0
                  ...
                  <div className="consortium-section-outer formsteps clearfix margin-bottom20 bottom-bordernone">
                   ...
                   <h4><strong>LLC or Corporation</strong></h4>
                    <ul className="tcp-listing">
                      ...
                      <li>Driver’s License</li>
                      <li>Renewal packet from CPUC</li>
                      <li>Statement of Information (Filed within last 2 years)</li>
