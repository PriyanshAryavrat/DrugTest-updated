...
class TransferTCP extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      tabIndex: 0
                  ...
                  <div className="consortium-section-outer formsteps clearfix margin-bottom20 bottom-bordernone">
                    ...
                    <div className="tcp-application-box">
                      ...
                      <ul className="tcp-listing">
                        ...
                        <li>$300 check made payable to CPUC</li>
                        <li>The name on the check must be the name of the applicant/individual</li>
                        <li>A $5 fee per driver in a check made payable to DMV</li>
                        <li>Each driver must be continuously enrolled in a drug testing program</li>
                      </ul>
                    </div>
                   ...
                   <h4><strong>LLC or Corporation</strong></h4>
                    <ul className="tcp-listing">
                      <li>$300 check made payable to "CPUC"</li>
                      <li>The name on the check must be the name of the LLC/Corporation or the name of a member of the LLC/Corporation that is listed in the Articles of Organization</li>
                      <li>A $5 fee per driver in a check made payable to DMV</li>
                      <li>Driver’s License</li>
                      <li>Commercial Vehicle Registration</li>
                      ...
                      <li><strong>If LLC:</strong> At least one member must be present to sign paperwork</li>
                      <li>Each driver must be continuously enrolled in a drug testing program</li>
                    </ul>
                   </div>
                   <div className="tcp-application-box">
